function PROJ_prof_rec_sep_drums_bass_melody()
data_dir    = 'Audio/';
results_dir  = 'Audio/';
file_name = 'Aaliyah_Sample.mp3';
%
...
audiowrite([results_dir file_name(1:end-4) '_est_melody.wav'],reshape(i_est(1,:,:),mix_nsamp,2),fs);
audiowrite([results_dir file_name(1:end-4) '_est_drums.wav'],reshape(i_est(2,:,:),mix_nsamp,2),fs);
audiowrite([results_dir file_name(1:end-4) '_est_bass.wav'],reshape(i_est(3,:,:),mix_nsamp,2),fs);
audiowrite([results_dir file_name(1:end-4) '_est_other.wav'],reshape(i_est(4,:,:),mix_nsamp,2),fs);
